...
//include='-D__USE_DEPRECATED_STACK_FUNCTIONS__ -I+ici;'+ici;
include='-D__USE_DEPRECATED_STACK_FUNCTIONS__ -I'+ici; 
ldflags='';
files=['sci_overload.c','overstack.c','overfuns.f','sci_dynlib.h','liboverload.c'];
//files=['sci_overload','overstack','overfuns','sci_dynlib']
//MSDOS = getos()
//if MSDOS then
